...
# Acceso al módulo
TC-PH-001 – Acceder correctamente a Purchase History desde el menú del perfil del usuario.
...
TC-PH-092 – Mantener sesión durante navegación.
...
TC-PH-112 – Navegación mediante teclado.
...
TC-PH-120 – Acceso sin mouse.


## Responsive Testing

# Desktop
TC-PH-121 – Visualización Full HD.
TC-PH-122 – Visualización Laptop.
