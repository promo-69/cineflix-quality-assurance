...
## Responsive Testing
TC-CHAT-111 – Visualización en escritorio.
TC-CHAT-112 – Visualización en laptop.
TC-CHAT-113 – Visualización en tablet.
TC-CHAT-114 – Visualización en móvil.
TC-CHAT-115 – Adaptación del contenedor del chat.
TC-CHAT-116 – Adaptación del campo de escritura.
TC-CHAT-117 – Adaptación del botón de voz.
TC-CHAT-118 – Evitar superposición con otros componentes.
TC-CHAT-119 – Mantener legibilidad de mensajes.
TC-CHAT-120 – Correcta visualización en orientación horizontal.
TC-CHAT-121 – Correcta visualización en orientación vertical.