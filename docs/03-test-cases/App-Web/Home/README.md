...
# Header
TC-HOME-007 – Mostrar opciones públicas cuando el usuario no está autenticado.
TC-HOME-008 – Mostrar opciones privadas después del inicio de sesión.
TC-HOME-009 – Ocultar botones privados sin autenticación.
TC-HOME-010 – Mostrar correctamente el menú del perfil.
TC-HOME-011 – Verificar funcionamiento del botón Cerrar Sesión.
TC-HOME-012 – Verificar persistencia del Header después de navegar entre páginas.
...
TC-HOME-080 – Mantener posición del scroll al regresar.
...
TC-HOME-094 – Navegación mediante teclado.
...
TC-HOME-102 – Escalado del texto al 200%.
TC-HOME-103 – Navegación completa sin mouse.


## Responsive Testing

# Desktop
TC-HOME-118 – Resolución Full HD.
TC-HOME-119 – Resolución 1366x768.
...
# Componentes
TC-HOME-125 – Adaptación del Header.
...
TC-HOME-132 – Adaptación del Footer.
TC-HOME-133 – Ausencia de scroll horizontal.
