...
TC-RR-004 – Mantener sesión activa al ingresar.
TC-RR-005 – Cargar correctamente el formulario.
...
TC-RR-110 – Navegación completa mediante teclado.
TC-RR-111 – Orden correcto del foco.
TC-RR-112 – Campos correctamente etiquetados.
TC-RR-113 – Lectura mediante lector de pantalla.
TC-RR-114 – Mensajes de error accesibles.
TC-RR-115 – Botón enviar accesible.
TC-RR-116 – Selector de fecha accesible.
TC-RR-117 – Contraste correcto.
TC-RR-118 – Escalado de texto.
TC-RR-119 – Interacción sin mouse.


## Responsive Testing

# Desktop
TC-RR-120 – Visualización Full HD.
TC-RR-121 – Visualización Laptop.

# Tablet
TC-RR-122 – Vista vertical.
TC-RR-123 – Vista horizontal.

# Mobile
TC-RR-124 – Pantallas pequeñas.
TC-RR-125 – Pantallas grandes.
TC-RR-126 – Cambio orientación.

# Componentes
TC-RR-127 – Adaptación formulario.
TC-RR-128 – Adaptación campos.
TC-RR-129 – Adaptación calendario.
TC-RR-130 – Adaptación botones.
TC-RR-131 – Adaptación mensajes.
TC-RR-132 – Ausencia de scroll horizontal.
TC-RR-133 – Correcta interacción táctil.