...
TC-BILL-101 – Navegación mediante teclado.
...
TC-BILL-109 – Acceso sin mouse.


## Responsive Testing

# Desktop
TC-BILL-110 – Visualización Full HD.
TC-BILL-111 – Visualización Laptop.

# Tablet
TC-BILL-112 – Vista vertical.
TC-BILL-113 – Vista horizontal.

# Mobile
TC-BILL-114 – Pantallas pequeñas.
TC-BILL-115 – Pantallas grandes.
TC-BILL-116 – Cambio de orientación.

# General
TC-BILL-117 – Adaptación de tarjetas.
TC-BILL-118 – Adaptación de posters.
TC-BILL-119 – Adaptación de filtros.
TC-BILL-120 – Correcta distribución del contenido.
TC-BILL-121 – Ausencia de scroll horizontal.
TC-BILL-122 – Legibilidad completa del contenido.
