...
TC-FY-075 – Navegación mediante teclado.
TC-FY-076 – Orden correcto del foco.
TC-FY-077 – Indicador visual del foco.
TC-FY-078 – Lectura mediante lector de pantalla.
TC-FY-079 – Texto alternativo en imágenes.
TC-FY-080 – Etiquetas accesibles para checkboxes de géneros.
TC-FY-081 – Etiquetas accesibles para botones.
TC-FY-082 – Contraste adecuado.
TC-FY-083 – Escalado del texto al 200%.
TC-FY-084 – Navegación completa sin mouse.


## Responsive Testing

# Desktop
TC-FY-085 – Visualización en resolución Full HD.
TC-FY-086 – Visualización en resolución 1366x768.

# Tablet
TC-FY-087 – Visualización en orientación vertical.
TC-FY-088 – Visualización en orientación horizontal.

# Mobile
TC-FY-089 – Visualización en teléfonos pequeños.
TC-FY-090 – Visualización en teléfonos grandes.
TC-FY-091 – Cambio de orientación del dispositivo.

# General
TC-FY-092 – Adaptación del modal.
TC-FY-093 – Adaptación del listado de géneros.
TC-FY-094 – Adaptación del carrusel "Para Ti".
TC-FY-095 – Correcta distribución de tarjetas de películas.
TC-FY-096 – Ausencia de scroll horizontal.
TC-FY-097 – Correcta visualización del contenido dinámico.