...
TC-PRO-058 – Invalidar el token anterior.
TC-PRO-059 – Impedir acceso a rutas privadas después del cierre de sesión.
TC-PRO-060 – Permitir iniciar sesión con las nuevas credenciales.
TC-PRO-061 – Rechazar las credenciales anteriores cuando corresponda.

# Persistencia
TC-PRO-063 – Mantener cambios después de iniciar sesión nuevamente.
TC-PRO-064 – Verificar persistencia desde otro dispositivo.
...
# Tablet
TC-PRO-111 – Vista vertical.
TC-PRO-112 – Vista horizontal.

# Mobile
TC-PRO-113 – Pantallas pequeñas.
TC-PRO-114 – Pantallas grandes.
TC-PRO-115 – Cambio de orientación.

# Componentes
TC-PRO-116 – Adaptación del formulario.
TC-PRO-117 – Adaptación de botones.
TC-PRO-118 – Adaptación de mensajes de validación.
TC-PRO-119 – Correcta distribución de campos.
TC-PRO-120 – Ausencia de scroll horizontal.
TC-PRO-121 – Correcta visualización del formulario completo.