...
Validar el correcto funcionamiento del módulo Cinemas en la aplicación móvil, garantizando que los usuarios puedan consultar las sucursales disponibles de Cineflix, visualizar la información detallada de cada una de ellas mediante componentes móviles y acceder de manera intuitiva a la cartelera de funciones filtrada por fecha a través de gestos táctiles nativos, asegurando una transición fluida hacia el flujo de compra de boletos.
...
- Consulta y renderizado de la lista de sucursales en formato móvil.
- Visualización de la información detallada de los cines (Dirección, horarios, contacto).
- Consulta de la cartelera de películas activa exclusiva de la sucursal.
- Filtrado de funciones mediante un carrusel de fechas nativo (Rango de 1 semana).
- Navegación e inyección de parámetros nativos hacia el flujo de compra de boletos.
- Gestión del ciclo de vida de la app e interrupciones en el dispositivo.
- Diseño responsivo en smartphones y tablets (Android).
- Integración con Backend y control de conectividad intermitente.
...
TC-CIN-078 – Tamaño adecuado de botones táctiles en dispositivos móviles.
TC-CIN-079 – Navegación completa sin utilizar mouse.


## Responsive Testing

# Tablet
TC-CIN-080 – Visualización en orientación vertical.
TC-CIN-084 – Visualización en orientación horizontal.

# Mobile
TC-CIN-081 – Visualización en teléfonos de pantalla pequeña.
TC-CIN-082 – Visualización en teléfonos de pantalla grande.
TC-CIN-083 – Cambio de orientación del dispositivo.

# General
TC-CIN-084 – Adaptación de tarjetas de sucursales.
TC-CIN-085 – Adaptación del calendario de fechas.
TC-CIN-086 – Adaptación de la cartelera de películas.
TC-CIN-087 – Correcta visualización de imágenes.
TC-CIN-088 – Ausencia de scroll horizontal.
TC-CIN-089 – Correcta distribución del contenido en todas las resoluciones.