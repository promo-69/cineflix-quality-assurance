...
TC-LOY-010 – Mostrar indicador visual del saldo disponible.
...
TC-LOY-057 – Navegar utilizando el botón "Atrás" del móvil.
...
# Tablet
TC-LOY-085 – Vista vertical.
TC-LOY-086 – Vista horizontal.

# Mobile
TC-LOY-087 – Pantallas pequeñas.
TC-LOY-088 – Pantallas grandes.
TC-LOY-089 – Cambio de orientación.

# Componentes
TC-LOY-090 – Adaptación de la tarjeta de CinePuntos.
TC-LOY-091 – Adaptación del nivel del cliente.
TC-LOY-092 – Adaptación del historial.
TC-LOY-093 – Adaptación de la tabla de equivalencias.
TC-LOY-094 – Correcta distribución del contenido.
TC-LOY-095 – Ausencia de scroll horizontal.
TC-LOY-096 – Legibilidad de toda la información.
TC-LOY-097 – Correcta visualización en todas las resoluciones.